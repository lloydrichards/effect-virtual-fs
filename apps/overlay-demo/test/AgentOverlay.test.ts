...
const call = (id: string, name: string, params: Readonly<Record<string, JsonValue>>): ModelStep => [{
  type: "tool-call",
  id,
  name,
  params,
...
const promptText = (request: LanguageModel.ProviderOptions) => JSON.stringify(request.prompt)
