...
) => Effect.Effect<Vfs.Volume, E | TransferError | Vfs.VfsError | PlatformError.PlatformError, R | Crypto.Crypto>
```
...
export declare const fromSnapshot: (
  ...
  root: Vfs.PathInput,
  options?: ReadOptions
) => Stream.Stream<Entry, TransferError | Vfs.VfsError | PlatformError.PlatformError, Crypto.Crypto>
```
