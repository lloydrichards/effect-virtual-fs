...
export declare const applySnapshotDelta: (
  ...
  [
    ...
    | Effect.Effect<
        Snapshot,
        ImageError | PlatformError.PlatformError | SnapshotDeltaModel.SnapshotDeltaError,
        Crypto.Crypto
      >
  ] extends [never]
    ? never
...
export declare const diffSnapshots: (
  ...
  [
    ...
    | Effect.Effect<
        ...
        never
      >
    | Effect.Effect<SnapshotDeltaModel.SnapshotDelta, ImageError | PlatformError.PlatformError, Crypto.Crypto>
  ] extends [never]
    ? never
    : [
          | Effect.Effect<never, VfsModel.ConfigurationError, never>
