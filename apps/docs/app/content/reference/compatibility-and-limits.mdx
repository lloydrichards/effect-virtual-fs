...
| `@effect-vfs/persistence` | `4.0.0-rc.114` | ESM only      | Named SQLite checkpoints and live-image storage                    |
| `@effect-vfs/nfs`         | `4.0.0-rc.114` | ESM only      | NFSv4.1 export with guarded experimental writes                   |
