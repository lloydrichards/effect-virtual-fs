...
| ------------------------------------------------------ | ---------------------- | --------------- | ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| maxfilesize                                            | 27                     | read-only-local | gap(#46)           | Volumes may lower `maxFileBytes`, and the export cannot observe the effective limit; advertising the core ceiling would lie for such volumes | #46   |
