...
| ------------------------------------------------------ | ---------------------- | ----------- | ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------- | ----- |
| maxfilesize                                            | 27                     | writable    | deferred(writable) | Answered from `volume.limits.maxFileBytes` once the [durability and usage facts](/decisions/core/volume-durability-and-usage-facts.md) land[^core] | #48   |
| space_total, space_free, space_avail                   | 44, 43, 42             | writable    | deferred(writable) | Derived from `volume.limits.maxBytes` and `volume.usage.usedBytes`; ATTRNOTSUPP when the volume is unlimited                                       | #48   |
| files_total, files_free, files_avail                   | 23, 22, 21             | writable    | deferred(writable) | Derived from `volume.limits.maxEntries` and `volume.usage.entries`; ATTRNOTSUPP when the volume is unlimited                                       | #48   |
