...
| owner                                | 36         | read-only-local | supported | Decimal uid string without domain                                                               | Internal #126 SETATTR accepts canonical uint32 decimal and rejects untranslatable strings with BADOWNER; see [owner-string decision](../../decisions/nfs/writable-owner-strings.md "constrained by") | #126  |
| owner_group                          | 37         | read-only-local | supported | Decimal gid string                                                                              | Internal #126 SETATTR uses the same translation as owner; see [owner-string decision](../../decisions/nfs/writable-owner-strings.md "constrained by")                                                | #126  |
