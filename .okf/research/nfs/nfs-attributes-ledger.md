...
| owner                                | 36         | read-only-local | supported | Decimal uid string without domain                                                               | Planned in #126: canonical uint32 decimal input and BADOWNER for untranslatable strings; see [owner-string decision](../../decisions/nfs/writable-owner-strings.md "constrained by") | #126  |
| owner_group                          | 37         | read-only-local | supported | Decimal gid string                                                                              | Same writable translation rule as owner; see [owner-string decision](../../decisions/nfs/writable-owner-strings.md "constrained by")                                                 | #126  |
