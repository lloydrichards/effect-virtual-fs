...
7. Serialisation on one tree schema, in three drafts: the value and one validator; Merkle identity, deltas and budget; NDJSON codecs and their consumers. The first is delivered: snapshots over the value, the internal tree and its converters, the live tree, and the fixture fold.
