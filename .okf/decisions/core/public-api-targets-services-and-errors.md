...
generated: { by: claude-code, at: "2026-09-25T22:30:00+02:00" }
---
...
10. **Declined for 0.6.0.** Recursive tree operations, path-scoped watch, an `EPERM` versus `EACCES` split, file-type bits in `Metadata`, an atomic `setattr`, an unscoped open, and a serialisable reference key each have their own issue.
