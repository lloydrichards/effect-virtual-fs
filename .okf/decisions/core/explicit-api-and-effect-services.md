...
Volume state, caller context, and handle lifetime remain separate. Supplying a caller through a service cannot replace its volume, credentials, or working directory. This API choice follows the [package boundary](/decisions/package-boundaries.md "constrained by") and does not itself define every export or operation.
