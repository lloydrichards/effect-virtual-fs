...
- [Reference keys](core/reference-keys.md) gives every object a serialisable key of volume identity, inode-number epoch and inode number, resolved on the volume, and makes NFS filehandles persistent over durable volumes.
