...
Snapshots own their contents and exclude live callers, handles, watches, and unreachable files. Version 1 images use strict JSON with base64 byte fields and image-local record identity. Decoding rejects noncanonical encodings, unknown schema fields, invalid graphs, and exhausted work budgets. Each restore creates independent storage and applies destination limits.
